...
from config import herbarium_dataroot, herbarium_partco_root
import glob

class HerbariumDataset19(torchvision.datasets.ImageFolder):
    patch_folder = herbarium_partco_root
    ...
    def __getitem__(self, idx):
        ...
        # get 1st order part-level correspondence label
        # Instead of using label to find the file, search for any file that matches the pattern
        patch_label_path = os.path.join(self.patch_folder, 'first_order_labels', f"img_{uq_idx}_label_1.png")
        ...
        return img, label, patch_label, uq_idx
