...
from config import cifar_10_root, cifar_100_root, cifar_10_partco_root, cifar_100_partco_root


class CustomCIFAR10(CIFAR10):
    patch_folder = cifar_10_partco_root
    ...
    def __getitem__(self, item):
        ...
        # get 2nd order part-level correspondence label
        patch_label_path = os.path.join(self.patch_folder, 'second_order_labels', f"img_{uq_idx}_class_{label}_label_2.png")
...
class CustomCIFAR100(CIFAR100):
    patch_folder = cifar_100_partco_root
