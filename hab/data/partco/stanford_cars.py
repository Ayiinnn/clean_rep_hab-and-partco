...
from config import car_root, car_partco_root

class CarsDataset(Dataset):
    """
        Cars Dataset
    """
    patch_folder = car_partco_root
    ...
    def __getitem__(self, idx):
        ...
        patch_sample = os.path.basename(self.data[idx]).split('.jpg')[0] + '_label.png'
        ...
        return image, target, patch_label, idx
