...
from config import cub_root, cub_partco_root
...
class CustomCub2011(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # remove the .jpg extension from sample.filepath
        patch_sample = sample.filepath.split('.jpg')[0] + '_label.png'
        ...
        return img, target, patch_label, self.uq_idxs[idx]
